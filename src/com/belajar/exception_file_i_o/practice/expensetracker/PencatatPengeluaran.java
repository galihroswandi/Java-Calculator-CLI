...
public class PencatatPengeluaran {
    ...
    public void lihatBerdasarkanKategori(String kategori) {
        ...
        for (Expense expense : pengeluaran) {
            if (expense.getCategory().equalsIgnoreCase(kategori)) {
    ...
    public void lihatRingkasanKategori() {
        ...
        for (Expense expense : pengeluaran) {
            String kategori = expense.getCategory();
    ...
    public void buatLaporanBulanan(int tahun, int bulan) {
        ...
        for (Expense expense : pengeluaran) {
            if (expense.getTanggal().getYear() == tahun &&
                    expense.getTanggal().getMonthValue() == bulan) {
        ...
        for (Expense expense : pengeluaranBulanan) {
            ...
            totalKategori.put(kategori,
                    totalKategori.getOrDefault(kategori, 0.0) + jumlah);
            totalJumlah += jumlah;
        }
    ...
    public void muatDariFile() {
        ...
        if (!file.exists()) {
            System.out.println("ℹ️  File data tidak ditemukan. Memulai dari awal.");
            return;
        }
    ...
    public ArrayList<String> getCategory() {
        ...
        for (Expense expense : pengeluaran) {
            String kat = expense.getCategory();
